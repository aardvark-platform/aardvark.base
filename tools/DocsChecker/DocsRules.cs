    ...
    public static DocsRules CreateDefault()
        => new()
        {
            ...
            [
                ...
                new("ai/TENSORS.md", "deterministic in-place", "Tensor docs should specify decomposition ordering and allocation semantics."),
            ...
            [
                ...
                new("src/Aardvark.Base.Tensors/Algorithms/QR.fs", "let inline setIdentityNative (matrix : NativeMatrixView< ^a >) ="),
                new("src/Aardvark.Base.Tensors/Algorithms/SVD.fs", "let inline svdDecomposeNative (eps : ^a) (U : NativeMatrixView< ^a >)"),
