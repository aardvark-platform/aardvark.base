    ...
    public static DocsRules CreateDefault()
        => new()
        {
            ...
            [
                ...
                new("ai/PRIMITIVE_TYPES.md", "`ComplexF` and `ComplexD` retain their mutable two-component value layout", "Primitive type docs should define complex finite-range semantics."),
                new("ai/PRIMITIVE_TYPES.md", "`NormSquared` intentionally remains the direct `Real * Real + Imag * Imag` operation", "Primitive type docs should distinguish robust magnitude from direct squared norm semantics."),
                new("ai/PRIMITIVE_TYPES.md", "negative-real-axis branch-cut behavior is preserved", "Primitive type docs should define compatible complex special-value behavior."),
                ...
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "`Ray3f.HitsSphere` and `Ray3d.HitsSphere` intersect finite rays", "Geometry semantics should define ray-sphere validity."),
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "Roots are considered in increasing parameter order", "Geometry semantics should define ray-sphere root ordering."),
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "Every sphere `out t`", "Geometry semantics should define ray-sphere miss output."),
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "normalized spatial fallback", "Geometry semantics should define extreme-scale ray-sphere arithmetic."),
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "`Ray3f.HitsCircle` and `Ray3d.HitsCircle` intersect", "Geometry semantics should define ray-circle intersections."),
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "The circle's supplied parameter interval is half-open", "Geometry semantics should define ray-circle range boundaries."),
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "Every `out t` miss writes NaN", "Geometry semantics should define ray-circle miss output."),
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "leave every field unchanged", "Geometry semantics should define ray-circle accumulator behavior."),
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "same component-scaled disk predicate as cylinder caps", "Geometry semantics should define extreme-scale disk containment."),
                ...
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "`Polygon2f`/`Polygon2d` centroid accumulation uses signed fan triangles", "Geometry semantics should define 2D polygon centroid invariants."),
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "`Polygon3f`/`Polygon3d` first computes the polygon's complete double-area normal", "Geometry semantics should define 3D polygon centroid projection."),
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "Fewer than three vertices and zero signed total weight return", "Geometry semantics should define degenerate polygon centroids."),
                new("ai/SEMANTICS_GEOMETRY_CORE.md", "packed SSE3/AVX2 lanes", "Geometry semantics should describe the accelerated 2D centroid path."),
            ...
            [
                ...
                new("src/Aardvark.Base/Math/Base/Complex_auto.cs", "private static float GetScaledNorm(float real, float imag, float squared)"),
                new("src/Aardvark.Base/Math/Base/Complex_auto.cs", "private static ComplexD GetScaledDivision(ComplexD numerator, ComplexD denominator, ComplexD direct)"),
                new("src/Aardvark.Base/Math/Base/Complex_auto.cs", "internal static ComplexD GetScaledSquareRoot(ComplexD value, ComplexD direct)"),
                ...
                new("src/Aardvark.Base/Geometry/Types/Ray/Ray3_auto.cs", "private readonly int GetSphereHit("),
                new("src/Aardvark.Base/Geometry/Types/Ray/Ray3_auto.cs", "private readonly int GetScaledSphereHit("),
                new("src/Aardvark.Base/Geometry/Types/Ray/Ray3_auto.cs", "private readonly bool TryGetCircleHit("),
                new("src/Aardvark.Base/Geometry/Types/Ray/Ray3_auto.cs", "private static bool IsInsideScaledDisk("),
                ...
                new("src/Aardvark.Base/Geometry/Types/Polygon/Polygon2_auto.cs", "public static V2d ComputeCentroid(this Polygon2d polygon)"),
                new("src/Aardvark.Base/Geometry/Types/Polygon/Polygon2_auto.cs", "anchor + centroidOffset * (Constant.OneThird / signedArea2)"),
                new("src/Aardvark.Base/Geometry/Types/Polygon/Polygon2_auto.cs", "if (Avx2.IsSupported) return ComputeCentroidVectorized"),
                new("src/Aardvark.Base/Geometry/Types/Polygon/Polygon2_auto.cs", "if (Sse3.IsSupported) return ComputeCentroidVectorized"),
                new("src/Aardvark.Base/Geometry/Types/Polygon/Polygon3_auto.cs", "public static V3d ComputeCentroid(this Polygon3d polygon)"),
                new("src/Aardvark.Base/Geometry/Types/Polygon/Polygon3_auto.cs", "if (ax >= ay && ax >= az)"),
