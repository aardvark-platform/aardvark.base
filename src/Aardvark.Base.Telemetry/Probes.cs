...
public static partial class Telemetry
{
    ...
    public class StopWatchTime : IProbe<TimeSpan>
    {
        ...
        public StopWatchTimeTimer Timer => new(this, Stopwatch.StartNew());
    ...
    public class CpuTime : IProbe<TimeSpan>
    {
        ...
        private readonly ThreadLocal<int> m_threadLocalWin32ThreadId = new(() => -1);
        private readonly ThreadLocal<ProcessThread> m_threadLocalProcessThread = new();
        
        private readonly ThreadLocal<bool> m_active = new(() => false);
    ...
    public class CpuTimeUser : IProbe<TimeSpan>
    {
        ...
        private readonly HashSet<int> m_threadIds = [];
    ...
    public class CustomProbeDouble(Func<double> valueFunc) : IProbe<double>
    {
        private readonly Func<double> m_value = valueFunc;
    ...
    public class CustomProbeLong(Func<long> valueFunc) : IProbe<long>
    {
        private readonly Func<long> m_value = valueFunc;
    ...
    public class CustomProbeTimeSpan(Func<TimeSpan> valueFunc) : IProbe<TimeSpan>
    {
        private Func<TimeSpan> m_value = valueFunc;
    ...
    public class CustomProbeString(Func<string> valueFunc) : IProbe<string>
    {
        private readonly Func<string> m_value = valueFunc;
