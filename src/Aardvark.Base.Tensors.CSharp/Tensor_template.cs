...
public struct __ttn__Info : ITensorInfo
{
    ...
    {
        readonly get { return [ /*# ifa.ForEach((f) => { */S__f__/*# }, comma); */ ]; }
    ...
    {
        readonly get { return [ /*# ifa.ForEach((f) => { */D__f__/*# }, comma); */ ]; }
    ...
    {
        readonly get { return [ /*# ifa.ForEach((f) => { */F__f__/*# }, comma); */ ]; }
...
public partial struct __ttn__<__dvtn__> : IValidity, I__ttn__<__vtn__>, IArray__ttn__
{
    ...
    {
        if (it1 is __ttn__<__vtn__> it1Typed) return Set(it1Typed);
        //# Loop("", false, () => {
                //# if (dt == vt) {
            ...
            double eps = 1e-8)
    {
        ...
        while (true)
        {
            if (yi == yieLeft) // next left edge
            {
                ...
                //if (deltaLeft < 0.0) { exit = true; break; } // compiler says "unnecessary assignment of a value to 'exit')
                if (deltaLeft < 0.0) break;
            ...
            if (yi == yieRight) // next right edge
            {
                ...
                //if (deltaRight < 0.0) { exit = true; break; } // compiler says "unnecessary assignment of a value to 'exit'"
                if (deltaRight < 0.0) break;
