    ...
    public static readonly Func<long, long, long, long, Tup5<long>>
        Index5SamplesClamped = (i, first, end, d) =>
        {
            ...
            if (i0 < 2)
            {
                return i0 switch
                {
                    1 => new Tup5<long>(-d, -d, 0L, d, d2),
                    0 => new Tup5<long>(0L, 0L, 0L, d, d2),
                    -1 => new Tup5<long>(d, d, d, d, d2),
                    _ => new Tup5<long>(-i0 * d),
                };
            }
            if (i1 > -2)
            {
                return i1 switch
                {
                    -1 => new Tup5<long>(-d2, d, 0L, d, d),
                    0 => new Tup5<long>(-d2, d, 0L, 0L, 0L),
                    1 => new Tup5<long>(-d2, -d, -d, -d, -d),
                    _ => new Tup5<long>(-i1 * d),
                };
            }
    ...
    public static readonly Func<long, long, long, long, Tup6<long>>
        Index6SamplesClamped = (i, first, end, d) =>
        {
            ...
            if (i0 < 2)
            {
                return i0 switch
                {
                    1 => new Tup6<long>(-d, -d, 0L, d, d2, d2 + d),
                    0 => new Tup6<long>(0L, 0L, 0L, d, d2, d2 + d),
                    -1 => new Tup6<long>(d, d, d, d, d2, d2 + d),
                    -2 => new Tup6<long>(d2, d2, d2, d2, d2, d2 + d),
                    _ => new Tup6<long>(-i0 * d),
                };
            }
            if (i1 > -3)
            {
                return i1 switch
                {
                    -2 => new Tup6<long>(-d2, -d, 0L, d, d2, d2),
                    -1 => new Tup6<long>(-d2, -d, 0L, d, d, d),
                    0 => new Tup6<long>(-d2, -d, 0L, 0L, 0L, 0L),
                    1 => new Tup6<long>(-d2, -d, -d, -d, -d, -d),
                    _ => new Tup6<long>(-i1 * d),
                };
            }
    ...
    public static readonly Func<long, long, long, long, Tup7<long>>
        Index7SamplesClamped = (i, first, end, d) =>
        {
            ...
            if (i0 < 3)
            {
                return i0 switch
                {
                    2 => new Tup7<long>(-d2, -d2, -d, 0L, d, d2, d2 + d),
                    1 => new Tup7<long>(-d, -d, -d, 0L, d, d2, d2 + d),
                    0 => new Tup7<long>(0L, 0L, 0L, 0L, d, d2, d2 + d),
                    -1 => new Tup7<long>(d, d, d, d, d, d2, d2 + d),
                    -2 => new Tup7<long>(d2, d2, d2, d2, d2, d2, d2 + d),
                    _ => new Tup7<long>(-i0 * d),
                };
            }
            if (i1 > -3)
            {
                return i1 switch
                {
                    -2 => new Tup7<long>(-d2 - d, -d2, -d, 0L, d, d2, d2),
                    -1 => new Tup7<long>(-d2 - d, -d2, -d, 0L, d, d, d),
                    0 => new Tup7<long>(-d2 - d, -d2, -d, 0L, 0L, 0L, 0L),
                    1 => new Tup7<long>(-d2 - d, -d2, -d, -d, -d, -d, -d),
                    2 => new Tup7<long>(-d2 - d, -d2, -d2, -d2, -d2, -d2, -d2),
                    _ => new Tup7<long>(-i1 * d),
                };
            }
...
public struct Tensor<T> : IValidity, ITensor<T>, IArrayTensorN
{
    ...
    public Tensor(long[] size)
    {
        m_rank = size.Length;
        m_size = size.Copy();
        m_delta = Tools.DenseDelta(m_size, out long total);
        m_data = new T[total];
        m_origin = 0;
    }
    ...
    public Tensor(T[] data, long origin, long[] size)
    {
        ...
        m_origin = origin;
        m_size = size.Copy();
        m_delta = Tools.DenseDelta(size, out _);
    }
