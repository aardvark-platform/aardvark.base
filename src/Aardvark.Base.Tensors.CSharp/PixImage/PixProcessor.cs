...
{
    private readonly Dictionary<Type, Func<PixImage, V2d, ImageInterpolation, PixImage>> scaleFuns = [];
    private readonly Dictionary<Type, Func<PixImage, double, bool, ImageInterpolation, PixImage>> rotateFuns = [];
    private readonly Dictionary<Type, Func<PixImage, Matrix<float>, Matrix<float>, ImageInterpolation, PixImage>> remapFuns = [];
