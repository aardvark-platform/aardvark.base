...
public static class ImageTensors
{
    ...
    public static Volume<Td, Tv> AsVolume<Td, Tv>(this Volume<Td> volume)
    {
        ...
        {
            Accessors = TensorAccessors.Get<Td, Tv>(TensorAccessors.Intent.ColorChannel, volume.DeltaArray)
        };
        return result;
    }
    ...
    public static Tensor4<Td, Tv> AsTensor4<Td, Tv>(this Tensor4<Td> tensor4)
    {
        ...
        {
            Accessors = TensorAccessors.Get<Td, Tv>(TensorAccessors.Intent.ColorChannel, tensor4.DeltaArray)
        };
        return result;
    }
