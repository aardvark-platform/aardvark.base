...
namespace Aardvark.Base
{
    ...
    /// </summary>
    [Obsolete("Moved to Aardvark.Base project in Aardvark.Base.SystemDrawingInterop namespace")]
    public static class SystemDrawingExtensions
    {
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static V2i ToV2i(Point p) => new V2i(p.X, p.Y);

        /// <summary>
        /// V2i to System.Drawing.Point.
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Point ToPoint(V2i p) => new Point(p.X, p.Y);
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static V2i ToV2i(Size s) => new V2i(s.Width, s.Height);

        /// <summary>
        /// V2i to System.Drawing.Size.
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Size ToSize(V2i v) => new Size(v.X, v.Y);
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Box2i ToBox2i(Rectangle r)
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Rectangle ToRectangle(Box2i p)
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Color ToColor(C3b color)
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static C3b ToC3b(Color color)
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Color ToColor(C3us color) => Color.FromArgb(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static C3us ToC3us(Color color) => new C3us(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Color ToColor(C3ui color) => Color.FromArgb(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static C3ui ToC3ui(Color color) => new C3ui(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Color ToColor(C3f color) => Color.FromArgb(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static C3f ToC3f(Color color) => new C3f(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Color ToColor(C3d color) => Color.FromArgb(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static C3d ToC3d(Color color) => new C3d(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Color ToColor(C4b color)
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static C4b ToC4b(Color color)
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Color ToColor(C4us color) => Color.FromArgb(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static C4us ToC4us(Color color) => new C4us(
            Col.UShortFromByte(color.R),
            Col.UShortFromByte(color.G),
            Col.UShortFromByte(color.B),
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Color ToColor(C4ui color) => Color.FromArgb(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static C4ui ToC4ui(Color color) => new C4ui(
            Col.UIntFromByte(color.R),
            Col.UIntFromByte(color.G),
            Col.UIntFromByte(color.B),
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Color ToColor(C4f color) => Color.FromArgb(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static C4f ToC4f(Color color) => new C4f(
            Col.FloatFromByte(color.R),
            Col.FloatFromByte(color.G),
            Col.FloatFromByte(color.B),
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static Color ToColor(C4d color) => Color.FromArgb(
        ...
        /// </summary>
        [Obsolete("Use extension from Aardvark.Base.SystemDrawingInterop")]
        public static C4d ToC4d(Color color) => new C4d(
            Col.DoubleFromByte(color.R),
            Col.DoubleFromByte(color.G),
            Col.DoubleFromByte(color.B),
