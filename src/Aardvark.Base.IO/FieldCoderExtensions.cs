...
public static class FieldCoderExtensions
{
    ...
    {
        return CreateFieldCoders(type, [.. members]);
    }
...
#if NETSTANDARD2_0
        var typeOfCodeMethodArdWithoutRef = Type.GetType(typeOfCodeMethodArg.FullName.Substring(0, typeOfCodeMethodArg.FullName.Length - 1));
#else
        var typeOfCodeMethodArdWithoutRef = Type.GetType(typeOfCodeMethodArg.FullName[..^1]);
#endif
        /* var v1 = */
        gen.DeclareLocal(typeOfCodeMethodArdWithoutRef);
