...
#pragma warning disable IDE0060, IDE0079, CA1822
    private object UseRef(Guid guid) =>
        // TODO
        null;
#pragma warning restore IDE0060, IDE0079, CA1822
    ...
    public void Code(ref object obj)
    {
        ...
        if (TryGetTypeInfo(typeName, out TypeInfo typeInfo))
        {
        ...
        if ((typeInfo.Options & TypeInfo.Option.Version) != 0)
        {
            ...
            {
                if (typeInfo.VersionMap.TryGetValue(m_version, out TypeInfo oldTypeInfo))
                {
            ...
            if (! TypeCoder.ReadPrimitive(this, typeInfo.Type, ref obj))
            {
                ...
                else
                {
                    ...
                    if (obj is IFieldCodeable fcobj)
                    {
                        ...
                        {
                            if (obj is ITypedMap tmobj) CodeFields(typeInfo.Type, tmobj);
                        }
                        if ((typeInfo.Options & TypeInfo.Option.Size) != 0)
                        {
                    ...
                    if (obj is IAwakeable aobj) aobj.Awake(codedVersion); // codedVersion
                    #endregion
...
#pragma warning restore CA1822, IDE0079, IDE0060
    {
        return null;
    }
    ...
    {
        int count = CodeCount(ref value, c => []);
        if (count < 1) return;
        while (count-- > 0)
        {
            object o = default(T); Code(ref o); value.Add((T)o);
    ...
    {
        t = t.GetElementType();
        return countArray.Length switch
        {
            1 => Array.CreateInstance(t, countArray[0]),
            2 => Array.CreateInstance(t, countArray[0], countArray[1]),
            3 => Array.CreateInstance(t, countArray[0], countArray[1], countArray[2]),
            _ => throw new ArgumentException("cannot decode array with more than 3 dimensions"),
        };
    }
    ...
    public void Code(Type t, ref IArrayMatrix value)
    {
        ...
        Array array = null; Code(value.ArrayType, ref array); value.Array = array;
        long origin = 0L; CodeLong(ref origin); value.Origin = origin;
        V2l length = default; CodeV2l(ref length); value.Size = length;
        V2l delta = default; CodeV2l(ref delta); value.Delta = delta;
    }
    ...
    public void Code(Type t, ref IArrayVolume value)
    {
        ...
        Array array = null; Code(value.ArrayType, ref array); value.Array = array;
        long origin = 0L; CodeLong(ref origin); value.Origin = origin;
        V3l length = default; CodeV3l(ref length); value.Size = length;
        V3l delta = default; CodeV3l(ref delta); value.Delta = delta;
    }
    ...
    public void Code(Type t, ref IArrayTensor4 value)
    {
        ...
        Array array = null; Code(value.ArrayType, ref array); value.Array = array;
        long origin = 0L; CodeLong(ref origin); value.Origin = origin;
        V4l length = default; CodeV4l(ref length); value.Size = length;
        V4l delta = default; CodeV4l(ref delta); value.Delta = delta;
    }
    ...
    public void CodeType(ref Type value)
    {
        ...
        if (TryGetTypeInfo(typeName, out TypeInfo ti))
            value = ti.Type;
        else
