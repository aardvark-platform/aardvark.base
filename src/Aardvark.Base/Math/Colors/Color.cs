...
public static partial class Col
{
    ...
    {
        if (s_formatChannelsMap.TryGetValue(format, out Channel[] channels))
            return channels;
    ...
    {
        if (s_channelIndexMap.TryGetValue((format, channel), out long index))
            return index;
        else
            return -1;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static double LabF(double t) { return t > s_labF_t3 ? Math.Pow(t, Constant.OneThird) : s_labF_t1 * t + s_labF_t0; }

    private const double s_labFinv_t3 = 6 / 29.0;
    private const double s_labFinv_t1 = 3.0 * (6 / 29.0) * (6 / 29.0);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static double LabFinv(double t) { return t > s_labFinv_t3 ? t * t * t : s_labFinv_t1 * (t - s_labF_t0); }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CieLabf ToCieLabf(this CieXYZf c, CieXYZf white)
    {
        var fy = LabF(c.Y / white.Y);
        return new CieLabf( 116.0 * fy - 16.0, 500.0 * (LabF(c.X / white.X) - fy), 200.0 * (fy - LabF(c.Z / white.Z)));
    }
    ...
    public static CieXYZf ToCieXYZf(this CieLabf c, CieXYZf white)
    {
        ...
        return new CieXYZf(white.Y * LabFinv(l), white.X * LabFinv(l + c.a * 0.002), white.Z * LabFinv(l - c.b * 0.005));
    }

    public static readonly Trafo2d ConeResponseDomain_XYZScaling = new(M33d.Identity, M33d.Identity);

    public static readonly Trafo2d ConeResponseDomain_Bradford = new(new M33d(0.8951000, 0.2664000, -0.1614000,
    ...
    public static readonly Trafo2d ConeResponseDomain_VonKries = new(new M33d(0.4002400, 0.7076000, -0.0808100,
    ...
    public static readonly CieXYZf CieXYZfAWhite = new(109.85, 100.0, 35.585);
    public static readonly CieXYZf CieXYZfBWhite = new(99.072, 100.0, 85.223);
    public static readonly CieXYZf CieXYZfCWhite = new(98.074, 100.0, 118.232);
    public static readonly CieXYZf CieXYZfD50White = new(96.422, 100.0, 82.521);
    public static readonly CieXYZf CieXYZfD55White = new(95.682, 100.0, 92.149);
    public static readonly CieXYZf CieXYZfD65White = new(95.047, 100.0, 108.883);
    public static readonly CieXYZf CieXYZfD75White = new(94.972, 100.0, 122.638);
    public static readonly CieXYZf CieXYZfEWhite = new(100.0, 100.0, 100.0);
    public static readonly CieXYZf CieXYZfF2White = new(99.186, 100.00, 67.393);
    public static readonly CieXYZf CieXYZfF7White = new(95.041, 100.00, 108.747);
    public static readonly CieXYZf CieXYZfF11White = new(100.962, 100.00, 64.350);
    ...
    public static C3f ToC3f(this HSLf c)
    {
        ...
        var m = c.L - 0.5 * chr;
        return (int)(h * 6.0) switch
        {
            0 => new C3f(chr + m, x + m, m),
            1 => new C3f(x + m, chr + m, m),
            2 => new C3f(m, chr + m, x + m),
            3 => new C3f(m, x + m, chr + m),
            4 => new C3f(x + m, m, chr + m),
            5 => new C3f(chr + m, m, x + m),
            _ => throw new ArgumentException("will never occur"),
        };
    }
...
#if NETSTANDARD2_0
    private static readonly Regex regexHexSgl = new("^(?:#|0x)?(?<R>[0-9a-fA-F])(?<G>[0-9a-fA-F])(?<B>[0-9a-fA-F])(?<A>[0-9a-fA-F])?$", RegexOptions.Compiled);
    private static readonly Regex regexHexDbl = new("^(?:#|0x)?(?<R>[0-9a-fA-F]{2})(?<G>[0-9a-fA-F]{2})(?<B>[0-9a-fA-F]{2})(?<A>[0-9a-fA-F]{2})?$", RegexOptions.Compiled);
#else
    [GeneratedRegex("^(?:#|0x)?(?<R>[0-9a-fA-F])(?<G>[0-9a-fA-F])(?<B>[0-9a-fA-F])(?<A>[0-9a-fA-F])?$", RegexOptions.Compiled)]
    private static partial Regex GeneratedRegexHexSgl();
    private static readonly Regex regexHexSgl = GeneratedRegexHexSgl();

    [GeneratedRegex("^(?:#|0x)?(?<R>[0-9a-fA-F]{2})(?<G>[0-9a-fA-F]{2})(?<B>[0-9a-fA-F]{2})(?<A>[0-9a-fA-F]{2})?$", RegexOptions.Compiled)]
    private static partial Regex GeneratedRegexHexDbl();
    private static readonly Regex regexHexDbl = GeneratedRegexHexDbl();
#endif
    private static bool TryParseHex(Regex regex, string input, out C4b result)
    {
        ...
        if (m.Success)
        {
            ...
            [
                ...
                m.Groups["G"].Value,
                m.Groups["B"].Value,
                m.Groups["A"].Success ? m.Groups["A"].Value : "FF",
            ];
            result =
...
[DataContract]
[Serializable]
public readonly struct PixFormat(Type type, Col.Format format) : IEquatable<PixFormat>
{
    [DataMember]
    public readonly Type Type = type;
    [DataMember]
    public readonly Col.Format Format = format;

    #region Predefined PixFormats

    public static readonly PixFormat ByteBW             = new(typeof(byte), Col.Format.BW);
    public static readonly PixFormat ByteGray           = new(typeof(byte), Col.Format.Gray);
    public static readonly PixFormat ByteGrayAlpha      = new(typeof(byte), Col.Format.GrayAlpha);
    public static readonly PixFormat ByteRG             = new(typeof(byte), Col.Format.RG);
    public static readonly PixFormat ByteBGR            = new(typeof(byte), Col.Format.BGR);
    public static readonly PixFormat ByteRGB            = new(typeof(byte), Col.Format.RGB);
    public static readonly PixFormat ByteBGRA           = new(typeof(byte), Col.Format.BGRA);
    public static readonly PixFormat ByteRGBA           = new(typeof(byte), Col.Format.RGBA);
    public static readonly PixFormat ByteBGRP           = new(typeof(byte), Col.Format.BGRP);
    public static readonly PixFormat ByteRGBP           = new(typeof(byte), Col.Format.RGBP);

    public static readonly PixFormat SByteBW            = new(typeof(sbyte), Col.Format.BW);
    public static readonly PixFormat SByteGray          = new(typeof(sbyte), Col.Format.Gray);
    public static readonly PixFormat SByteGrayAlpha     = new(typeof(sbyte), Col.Format.GrayAlpha);
    public static readonly PixFormat SByteRG            = new(typeof(sbyte), Col.Format.RG);
    public static readonly PixFormat SByteBGR           = new(typeof(sbyte), Col.Format.BGR);
    public static readonly PixFormat SByteRGB           = new(typeof(sbyte), Col.Format.RGB);
    public static readonly PixFormat SByteBGRA          = new(typeof(sbyte), Col.Format.BGRA);
    public static readonly PixFormat SByteRGBA          = new(typeof(sbyte), Col.Format.RGBA);
    public static readonly PixFormat SByteBGRP          = new(typeof(sbyte), Col.Format.BGRP);
    public static readonly PixFormat SByteRGBP          = new(typeof(sbyte), Col.Format.RGBP);

    public static readonly PixFormat UShortGray         = new(typeof(ushort), Col.Format.Gray);
    public static readonly PixFormat UShortGrayAlpha    = new(typeof(ushort), Col.Format.GrayAlpha);
    public static readonly PixFormat UShortRG           = new(typeof(ushort), Col.Format.RG);
    public static readonly PixFormat UShortBGR          = new(typeof(ushort), Col.Format.BGR);
    public static readonly PixFormat UShortRGB          = new(typeof(ushort), Col.Format.RGB);
    public static readonly PixFormat UShortBGRA         = new(typeof(ushort), Col.Format.BGRA);
    public static readonly PixFormat UShortRGBA         = new(typeof(ushort), Col.Format.RGBA);
    public static readonly PixFormat UShortBGRP         = new(typeof(ushort), Col.Format.BGRP);
    public static readonly PixFormat UShortRGBP         = new(typeof(ushort), Col.Format.RGBP);

    public static readonly PixFormat ShortGray          = new(typeof(short), Col.Format.Gray);
    public static readonly PixFormat ShortGrayAlpha     = new(typeof(short), Col.Format.GrayAlpha);
    public static readonly PixFormat ShortRG            = new(typeof(short), Col.Format.RG);
    public static readonly PixFormat ShortBGR           = new(typeof(short), Col.Format.BGR);
    public static readonly PixFormat ShortRGB           = new(typeof(short), Col.Format.RGB);
    public static readonly PixFormat ShortBGRA          = new(typeof(short), Col.Format.BGRA);
    public static readonly PixFormat ShortRGBA          = new(typeof(short), Col.Format.RGBA);
    public static readonly PixFormat ShortBGRP          = new(typeof(short), Col.Format.BGRP);
    public static readonly PixFormat ShortRGBP          = new(typeof(short), Col.Format.RGBP);

    public static readonly PixFormat UIntGray           = new(typeof(uint), Col.Format.Gray);
    public static readonly PixFormat UIntGrayAlpha      = new(typeof(uint), Col.Format.GrayAlpha);
    public static readonly PixFormat UIntRG             = new(typeof(uint), Col.Format.RG);
    public static readonly PixFormat UIntBGR            = new(typeof(uint), Col.Format.BGR);
    public static readonly PixFormat UIntRGB            = new(typeof(uint), Col.Format.RGB);
    public static readonly PixFormat UIntBGRA           = new(typeof(uint), Col.Format.BGRA);
    public static readonly PixFormat UIntRGBA           = new(typeof(uint), Col.Format.RGBA);
    public static readonly PixFormat UIntBGRP           = new(typeof(uint), Col.Format.BGRP);
    public static readonly PixFormat UIntRGBP           = new(typeof(uint), Col.Format.RGBP);

    public static readonly PixFormat IntGray            = new(typeof(int), Col.Format.Gray);
    public static readonly PixFormat IntGrayAlpha       = new(typeof(int), Col.Format.GrayAlpha);
    public static readonly PixFormat IntRG              = new(typeof(int), Col.Format.RG);
    public static readonly PixFormat IntBGR             = new(typeof(int), Col.Format.BGR);
    public static readonly PixFormat IntRGB             = new(typeof(int), Col.Format.RGB);
    public static readonly PixFormat IntBGRA            = new(typeof(int), Col.Format.BGRA);
    public static readonly PixFormat IntRGBA            = new(typeof(int), Col.Format.RGBA);
    public static readonly PixFormat IntBGRP            = new(typeof(int), Col.Format.BGRP);
    public static readonly PixFormat IntRGBP            = new(typeof(int), Col.Format.RGBP);

    public static readonly PixFormat HalfGray           = new(typeof(Half), Col.Format.Gray);
    public static readonly PixFormat HalfGrayAlpha      = new(typeof(Half), Col.Format.GrayAlpha);
    public static readonly PixFormat HalfRG             = new(typeof(Half), Col.Format.RG);
    public static readonly PixFormat HalfBGR            = new(typeof(Half), Col.Format.BGR);
    public static readonly PixFormat HalfRGB            = new(typeof(Half), Col.Format.RGB);
    public static readonly PixFormat HalfBGRA           = new(typeof(Half), Col.Format.BGRA);
    public static readonly PixFormat HalfRGBA           = new(typeof(Half), Col.Format.RGBA);
    public static readonly PixFormat HalfBGRP           = new(typeof(Half), Col.Format.BGRP);
    public static readonly PixFormat HalfRGBP           = new(typeof(Half), Col.Format.RGBP);

    public static readonly PixFormat FloatGray          = new(typeof(float), Col.Format.Gray);
    public static readonly PixFormat FloatGrayAlpha     = new(typeof(float), Col.Format.GrayAlpha);
    public static readonly PixFormat FloatRG            = new(typeof(float), Col.Format.RG);
    public static readonly PixFormat FloatBGR           = new(typeof(float), Col.Format.BGR);
    public static readonly PixFormat FloatRGB           = new(typeof(float), Col.Format.RGB);
    public static readonly PixFormat FloatBGRA          = new(typeof(float), Col.Format.BGRA);
    public static readonly PixFormat FloatRGBA          = new(typeof(float), Col.Format.RGBA);
    public static readonly PixFormat FloatBGRP          = new(typeof(float), Col.Format.BGRP);
    public static readonly PixFormat FloatRGBP          = new(typeof(float), Col.Format.RGBP);

    public static readonly PixFormat DoubleGray         = new(typeof(double), Col.Format.Gray);
    public static readonly PixFormat DoubleGrayAlpha    = new(typeof(double), Col.Format.GrayAlpha);
    public static readonly PixFormat DoubleRG           = new(typeof(double), Col.Format.RG);
    public static readonly PixFormat DoubleBGR          = new(typeof(double), Col.Format.BGR);
    public static readonly PixFormat DoubleRGB          = new(typeof(double), Col.Format.RGB);
    public static readonly PixFormat DoubleBGRA         = new(typeof(double), Col.Format.BGRA);
    public static readonly PixFormat DoubleRGBA         = new(typeof(double), Col.Format.RGBA);
    public static readonly PixFormat DoubleBGRP         = new(typeof(double), Col.Format.BGRP);
    public static readonly PixFormat DoubleRGBP         = new(typeof(double), Col.Format.RGBP);
    ...
    {
        return obj is PixFormat format1 && this == format1;
    }
...
public partial struct CieLabf : IEquatable<CieLabf>
{
    ...
    public override readonly bool Equals(object other) => (other is CieLabf o) && Equals(o);
...
public partial struct CieLuvf : IEquatable<CieLuvf>
{
    ...
    public override readonly bool Equals(object other) => (other is CieLuvf o) && Equals(o);
...
public partial struct CieXYZf : IEquatable<CieXYZf>
{
    ...
    public override readonly bool Equals(object other) => (other is CieXYZf o) && Equals(o);
...
public partial struct CieYxyf : IEquatable<CieYxyf>
{
    ...
    public override readonly bool Equals(object other) => (other is CieYxyf o) && Equals(o);
...
public partial struct CMYKf : IEquatable<CMYKf>
{
    ...
    public override readonly bool Equals(object other) => (other is CMYKf o) && Equals(o);
...
public partial struct HSLf : IEquatable<HSLf>
{
    ...
    public override readonly bool Equals(object other) => (other is HSLf o) && Equals(o);
...
public partial struct HSVf : IEquatable<HSVf>
{
    ...
    public override readonly bool Equals(object other) => (other is HSVf o) && Equals(o);
...
public partial struct Yuvf : IEquatable<Yuvf>
{
    ...
    public override readonly bool Equals(object other) => (other is Yuvf o) && Equals(o);
