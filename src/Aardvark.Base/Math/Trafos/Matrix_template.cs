...
public partial struct __nmtype__ : IEquatable<__nmtype__>, IValidity, IMatrix<double>
{
    ...
    public static __nmtype__ RotationEuler(__ftype__ rollInRadians, __ftype__ pitchInRadians, __ftype__ yawInRadians)
        => (__nmtype__)(Rot__x3t__.RotationEuler(rollInRadians, pitchInRadians, yawInRadians));
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return new(/*# m.ForEach(f => {*/ M__k____f__/*#}, comma); */); }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set
        {
            //# mfields.ForEach((f, j) => {
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return new(/*# n.ForEach(f => {*/ M__f____k__/*#}, comma); */); }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set
        {
            //# nfields.ForEach((f, j) => {
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(/*# n.ForEach(i => {*/M__i____i__/*#}, comma); */);
    }
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(/*# n.ForEach(i => { var j = n - 1 - i; */M__i____j__/*#}, comma); */);
    }
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(/*# n.ForEach(i => { m.ForEach(j => { var v = i == j ? "1" : "0"; */__v__/*# }, comma); }, comma); */);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(__nmtype__ a, __nmtype__ b) => !(a == b);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(__nmtype__ m, __ftype__ s) => !(m == s);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(__ftype__ s, __nmtype__ m) => !(s == m);
    ...
    public override readonly int GetHashCode()
        => HashCode.GetCombined(/*# n.ForEach(r => { */
    ...
    public override readonly bool Equals(object other)
        => (other is __nmtype__ o) && Equals(o);
    ...
    public readonly __nmtype__ Adjoint
    {
        ...
        {
            //# if (n == 2) {
            return new(M11, -M10, -M01, M00);
            //# } else {
            var result = new __nmtype__();
    ...
    //# if (t > 1) {
    private static V2l s_luSize = new(__n__, __n__);
    private static V2l s_luDelta = new(1, __n__);
    ...
    {
        return new(/*# n.ForEach(r => { *//*# a.ForEach(s => { */
    ...
    {
        return new(/*# n.ForEach(r => { *//*# b.ForEach(s => { */
            /*# a.ForEach(u => {*/a.M__r____u__ * b.M__u____s__/*# }, add);}, comma);}, comma); */
         );
    }
...
{
    public static readonly __nmtype__EqualityComparer Default = new();

    #region IEqualityComparer<__nmtype__> Members

    public bool Equals(__nmtype__ v0, __nmtype__ v1) => v0 == v1;

    public int GetHashCode(__nmtype__ v) => v.GetHashCode();
...
public static partial class Mat
{
    ...
    public static __vnctype__ GetScaleVector(this __nmtype__ m)
        => new(/*# n.ForEach(i => {*/m.C__i__.Length/*# }, comma);*/);
    ...
    public static __vnsub1ctype__ GetScaleVector__nsub1__(this __nmtype__ m)
        => new(/*# nsub1.ForEach(i => {*/m.C__i__.__xyznsub1__.Length/*# }, comma);*/);
    ...
    public static __ctype__ Distance2(this __nmtype__ a, __nmtype__ b)
        => /*# if (ctype != "double") {*/(__ctype__)/*# } */Fun.Sqrt(/*# n.ForEach(i => { m.ForEach(j => { */
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool Invert(this ref __nmtype__ m) => m.LuInvert();
    ...
    public static bool IsIdentity(this __nmtype__ m, __ftype__ epsilon)
        => Fun.ApproximateEquals(m, __nmtype__.Identity, epsilon);
...
public static partial class Fun
{
    ...
    public static bool ApproximateEquals(this __nmtype__ a, __nmtype__ b, __ftype__ epsilon)
        => Mat.DistanceMax(a, b) <= epsilon; //Inefficient implementation, no early exit of comparisons.
