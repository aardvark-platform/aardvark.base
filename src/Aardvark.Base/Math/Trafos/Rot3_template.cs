...
public partial struct __type__ : IEquatable<__type__>
{
    ...
    {
        var r = (__m33t__)rot;
        return new(/*# 3.ForEach(i => { 4.ForEach(j => {*/
    ...
    {
        var r = (__m33t__)rot;
        return new(/*# 4.ForEach(i => { 3.ForEach(j => {*/
    ...
    public static __quatt__ operator +(__type__ r, __quatt__ q)
        => new(/*# qfields.ForEach(f => {*/r.__f__ + q.__f__/*# }, comma);*/);
    ...
    public static __quatt__ operator +(__quatt__ q, __type__ r)
        => new(/*# qfields.ForEach(f => {*/q.__f__ + r.__f__/*# }, comma);*/);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __quatt__ operator *(__type__ r, __ftype__ s)
        => new(/*# qfields.ForEach(f => {*/r.__f__ * s/*# }, comma);*/);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __quatt__ operator /(__ftype__ s, __type__ r)
        => new(/*# qfields.ForEach(f => {*/s / r.__f__/*# }, comma);*/);
    ...
    public static __type__ FromFrame(__v3t__ x, __v3t__ y, __v3t__ z)
        => From__m33t__(__m33t__.FromCols(x, y, z));
    ...
    public static __type__ From__m33t__(__m33t__ m, __ftype__ epsilon = (__ftype__)1e-6)
    {
        ...
        if (tr > 0)
        {
            ...
            __ftype__ w = s / 4;
            return new(new __quatt__(w, x, y, z).Normalized);
        }
    ...
    public static __type__ RotateInto(__v3t__ from, __v3t__ into)
    {
        ...
        {
            var q = new __quatt__(d + 1, Vec.Cross(from, into));
    ...
    {
        var halfAngle = angleInRadians / 2;
        return new(halfAngle.Cos(), new __v3t__(halfAngle.Sin(), 0, 0));
    }
    ...
    {
        var halfAngle = angleInRadians / 2;
        return new(halfAngle.Cos(), new __v3t__(0, halfAngle.Sin(), 0));
    }
    ...
    {
        var halfAngle = angleInRadians / 2;
        return new(halfAngle.Cos(), new __v3t__(0, 0, halfAngle.Sin()));
    }
    ...
    public static explicit operator __trafo3t__(__type__ r)
        => new((__m44t__)r, (__m44t__)r.Inverse);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator __type2__(__type__ r)
        => new(/*# qfields.ForEach(f => {*/(__ftype2__)r.__f__/*# }, comma);*/);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator __quatt__(__type__ r)
        => new(/*# qfields.ForEach(f => {*/r.__f__/*# }, comma);*/);
    ...
    public static __type__ Parse(string s)
    {
        ...
        return new(__ftype__.Parse(x[0], CultureInfo.InvariantCulture), __v3t__.Parse(x[1]));
    }
