...
public partial struct __type__ : IEquatable<__type__>
{
    ...
    {
        Scale = 1;
        Euclidean = new(rotation, /*# nfields.ForEach(f => { */t__f__/*# }, comma);*/);
    }
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(1, __euclideannt__.Identity);
    }
    ...
    public static __type__ operator *(__type__ a, __type__ b)
    {
        ...
        return new(a.Scale * b.Scale, new __euclideannt__(
            a.Rot * b.Rot,
    ...
    {
        var t = (__mnmt__)s;
        return new(/*# n.ForEach(i => { m.ForEach(j => { */
            /*# m.ForEach(k => {
    ...
    {
        var t = (__mnmt__)s;
        return new(/*# m.ForEach(i => { m.ForEach(j => { */
            /*# n.ForEach(k => {
    ...
    {
        var t = (__mnnt__)a;
        return new(new __mnnt__(/*# nfields.ForEach((fi, i) => { */
    ...
    public static __type__ From__mnnt__And__vnt__(__mnnt__ m, __vnt__ trans, __ftype__ epsilon = __eps__)
    {
        ...
        m /= s;
        return new(s, __euclideannt__.From__mnnt__And__vnt__(m, trans/*# if (n > 2) {*/, epsilon/*# }*/));
    }
...
#pragma warning restore IDE0060 // Remove unused parameter
    ...
    public static __type__ From__scalent__(__scalent__ scale, __ftype__ epsilon = __eps__)
    {
        ...
        return new(s, __euclideannt__.Identity);
    }
    ...
    public static __type__ Translation(/*# nfields.ForEach(f => { */__ftype__ t__f__/*# }, comma); */)
        => new(__rotnt__.Identity, /*# nfields.ForEach(f => { */t__f__/*# }, comma); */);
    ...
    public static __type__ Translation(__shiftnt__ shift)
        => new(__rotnt__.Identity, shift.V);
    ...
    public static __type__ Rotation(__ftype__ angleInRadians)
        => new(new __rotnt__(angleInRadians), __vnt__.Zero);
    ...
    public static __type__ Rotation(__vnt__ normalizedAxis, __ftype__ angleRadians)
        => new(__rotnt__.Rotation(normalizedAxis, angleRadians), __vnt__.Zero);
    ...
    public static __type__ RotationEuler(__ftype__ rollInRadians, __ftype__ pitchInRadians, __ftype__ yawInRadians)
        => new(__rotnt__.RotationEuler(rollInRadians, pitchInRadians, yawInRadians), __vnt__.Zero);
    ...
    public static __type__ RotateInto(__vnt__ from, __vnt__ into)
        => new(__rotnt__.RotateInto(from, into), __vnt__.Zero);
    ...
    public static __type__ RotationX(__ftype__ angleRadians)
        => new(__rotnt__.RotationX(angleRadians), __vnt__.Zero);
    ...
    public static __type__ RotationY(__ftype__ angleRadians)
        => new(__rotnt__.RotationY(angleRadians), __vnt__.Zero);
    ...
    public static __type__ RotationZ(__ftype__ angleRadians)
        => new(__rotnt__.RotationZ(angleRadians), __vnt__.Zero);
    ...
    {
        var m = (__mnmt__)s;
        return new((__mnnt__)m, m.C__n__);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator __trafont__(__type__ s)
        => new((__mmmt__)s, (__mmmt__)s.Inverse);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator __type2__(__type__ s)
        => new((__ftype2__)s.Scale, (__euclideannt2__)s.Euclidean);
    ...
    public static __type__ Parse(string s)
    {
        ...
        return new(__ftype__.Parse(x[0], CultureInfo.InvariantCulture), __euclideannt__.Parse(x[1]));
    }
...
public static partial class Fun
{
    ...
    public static bool ApproximateEquals(this __type__ t0, __type__ t1)
        => ApproximateEquals(t0, t1, Constant<__ftype__>.PositiveTinyValue);
