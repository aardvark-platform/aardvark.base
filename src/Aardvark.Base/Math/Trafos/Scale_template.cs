...
namespace Aardvark.Base
{
    ...
    public partial struct __type__
    {
        ...
        /// <summary>
        /// Multiplies a <see cref="__vdt__"/> with the inverse of a <see cref="__type__"/> transformation.
        /// Attention: Multiplication is NOT commutative!
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static __vdt__ operator *(__vdt__ vector, __type__ scale)
        {
            return new __vdt__(/*# dfields.ForEach(f => { */vector.__f__ / scale.__f__/*# }, comma); */);
        }
    ...
    public static partial class Scale
    {
        ...
        //# var vec = "V" + n + tc;
        //# var r = (d > n) ? n : d;
        //# var rfields = fields.Take(r);
        //# var rem = n - r;
        //# var constfields = fields.Skip(r).Take(rem);
        ...
        public static __vec__ Transform(this __type__ s, __vec__ v)
            => new __vec__(/*# rfields.ForEach(f => {*/v.__f__ * s.__f__/*# }, comma);
                if (rem > 0) {*/, /*# rem.ForEach(i => {
                var f = fields[r + i]; */v.__f__/*#}, comma); } */);
