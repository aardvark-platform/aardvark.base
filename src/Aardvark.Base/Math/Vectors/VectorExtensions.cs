...
namespace Aardvark.Base
{
    public static class VectorExtensions
    {
        ...
        public static V2i Sum(this IEnumerable<V2i> vs) => vs.Aggregate((a, v) => a + v);

        public static V2l Sum(this IEnumerable<V2l> vs) => vs.Aggregate((a, v) => a + v);

        public static V2f Sum(this IEnumerable<V2f> vs) => vs.Aggregate((a, v) => a + v);

        public static V2d Sum(this IEnumerable<V2d> vs) => vs.Aggregate((a, v) => a + v);

        public static V3i Sum(this IEnumerable<V3i> vs) => vs.Aggregate((a, v) => a + v);

        public static V3l Sum(this IEnumerable<V3l> vs) => vs.Aggregate((a, v) => a + v);

        public static V3f Sum(this IEnumerable<V3f> vs) => vs.Aggregate((a, v) => a + v);

        public static V3d Sum(this IEnumerable<V3d> vs) => vs.Aggregate((a, v) => a + v);

        public static V4i Sum(this IEnumerable<V4i> vs) => vs.Aggregate((a, v) => a + v);

        public static V4l Sum(this IEnumerable<V4l> vs) => vs.Aggregate((a, v) => a + v);

        public static V4f Sum(this IEnumerable<V4f> vs) => vs.Aggregate((a, v) => a + v);

        public static V4d Sum(this IEnumerable<V4d> vs) => vs.Aggregate((a, v) => a + v);
