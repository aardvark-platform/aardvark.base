...
public partial struct __vtype__ : IVector<double>, ISize__d____fchar__, IFormattable, IEquatable<__vtype__>
{
    ...
    //#     if (vt != vt1) {
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator __vtype__(__vtype1__ v) => new(v);
    ...
    public readonly V__d____ichar__ To__floor__V__d____ichar__()
        => new(/*# vt.Fields.ForEach(f => { */(__icast__)Fun.__floor__(__f__)/*# }, comma); */);
    ...
    {
        var div = 1 / __lastF__;
        return new(/*# vt1.Fields.ForEach(f => { */__f__ * div/*# }, comma); */);
    }
    ...
    public readonly __vtype1__ To__vtype1__Homo()
        => new(/*# fields.ForEach(f => { */__f__/*# }, comma); */, 1);
    ...
    public readonly __vtype1__ Copy(Func<__ftype__, __ftype1__> element_fun)
        => new(/*# fields.ForEach(f => { */element_fun(__f__)/*# }, comma); */);
    ...
    public readonly __vtype1__ Copy(Func<__ftype__, int, __ftype1__> element_index_fun)
        => new(/*# fields.ForEach((f, i) => { */element_index_fun(__f__, __i__)/*# }, comma); */);
    ...
    /// All elements zero.
    /// </summary>
    public static __vtype__ Zero => new(/*# d.ForEach(i => { */0/*# }, comma); */);

    //# if (ft.IsReal) {
    /// <summary>
    /// All elements half.
    /// </summary>
    public static __vtype__ Half => new(/*# d.ForEach(i => { */0.5/*# }, comma); */);
    //# } // ft.IsReal

    /// <summary>
    /// All elements one.
    /// </summary>
    public static __vtype__ One => new(/*# d.ForEach(i => { */1/*# }, comma); */);

    /// <summary>
    /// All elements set to maximum possible value.
    /// </summary>
    public static __vtype__ MaxValue => new(/*# d.ForEach(i => { */Constant<__ftype__>.ParseableMaxValue/*# }, comma); */);

    /// <summary>
    /// All elements set to minimum possible value.
    /// </summary>
    public static __vtype__ MinValue => new(/*# d.ForEach(i => { */Constant<__ftype__>.ParseableMinValue/*# }, comma); */);

    //# if (ft.IsReal) {
     /// <summary>
    /// All elements set to negative infinity.
    /// </summary>
    public static __vtype__ NegativeInfinity => new(/*# d.ForEach(i => { */__ftype__.NegativeInfinity/*# }, comma); */);

    /// <summary>
    /// All elements set to positive infinity.
    /// </summary>
    public static __vtype__ PositiveInfinity => new(/*# d.ForEach(i => { */__ftype__.PositiveInfinity/*# }, comma); */);

    /// <summary>
    /// All elements set to NaN.
    /// </summary>
    public static __vtype__ NaN => new(/*# d.ForEach(i => { */__ftype__.NaN/*# }, comma); */);
    ...
    /// </summary>
    public static __vtype__ __f__Axis => new(/*# d.ForEach(i => { var v = i != j ? 0 : 1; */__v__/*# }, comma); */);
    ...
    //#     if (ft != ft1) {
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ From__vtype1__(__vtype1__ v) => new(v);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ From__type1__(__type1__ c) => new(c);
    ...
    public static __vtype__ FromPolar(__ftype__ angleInRadians, __ftype__ radius)
        => new(Fun.Cos(angleInRadians) * radius, Fun.Sin(angleInRadians) * radius);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ FromPolar(__ftype__ angleInRadians)
        => new(Fun.Cos(angleInRadians), Fun.Sin(angleInRadians));
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ FromCubeFaceCode(int i)  => s_fromCubeCode[i];
    ...
    public readonly __vctype__ Normalized
    {
        ...
        get
        {
            ...
            s = 1 / s;
            return new(/*# fields.ForEach(f => { */__f__ * s/*# }, comma); */);
        }
    }
        ...
        //# }
            ...
            if (x > y)
            {
                if (x > z)
                {
                    ...
                    return new(Fun.Sign(X), Y * s, Z * s);
                }
                else
                {
                    double s = 1 / z;/*# if (face) { */ face = Z < 0 ? 2 : 5;/*# } */
                    return new(X * s, Y * s, Fun.Sign(Z));
                }
            }
            else
            {
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Abs(__vtype__ v) => v.Abs();

    //# }
    //# if (ft.IsReal) {
    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Floor(__vtype__ v) => v.Floor();

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Ceiling(__vtype__ v) => v.Ceiling();

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Round(__vtype__ v) => v.Round();

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Truncate(__vtype__ v) => v.Truncate();

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Acos(__vtype__ v) => Fun.Acos(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Acoshb(__vtype__ v) => Fun.Acosh(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Cos(__vtype__ v) => Fun.Cos(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Cosh(__vtype__ v) => Fun.Cosh(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Asin(__vtype__ v) => Fun.Asin(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Asinhb(__vtype__ v) => Fun.Asinh(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Sin(__vtype__ v) => Fun.Sin(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Sinh(__vtype__ v) => Fun.Sinh(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Atan(__vtype__ v) => Fun.Atan(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Atanhb(__vtype__ v) => Fun.Atanh(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Atan2(__vtype__ a, __vtype__ b) => Fun.Atan2(a, b);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Tan(__vtype__ v) => Fun.Tan(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Tanh(__vtype__ v) => Fun.Tanh(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Sqrt(__vtype__ v) => Fun.Sqrt(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ CubeRoot(__vtype__ v) => Fun.Cbrt(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Exp(__vtype__ v) => Fun.Exp(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Log(__vtype__ v) => Fun.Log(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ LogBinary(__vtype__ v) => Fun.Log2(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Log10(__vtype__ v) => Fun.Log10(v);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ CopySgn(__vtype__ value, __vtype__ sign) => Fun.CopySign(value, sign);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ CopySgn(__vtype__ value, __ftype__ sign) => Fun.CopySign(value, sign);
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ LinearInterp(__tt.Name__ t, __vtype__ a, __vtype__ b) => Fun.Lerp(t, a, b);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ LinearInterp(__vtt.Name__ t, __vtype__ a, __vtype__ b) => Fun.Lerp(t, a, b);

    //#}
    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Min(__vtype__ v0, __vtype__ v1) => Fun.Min(v0, v1);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Min(__vtype__ v, __ftype__ x) => Fun.Min(v, x);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Max(__vtype__ v0, __vtype__ v1) => Fun.Max(v0, v1);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Max(__vtype__ v, __ftype__ x) => Fun.Max(v, x);

    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Saturate(__vtype__ v) => Fun.Saturate(v);

    //# if (!unsigned) {
    [EditorBrowsable(EditorBrowsableState.Never)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ DivideByInt(__vtype__ v, int x) => v / x;
    ...
    public static __vtype__ operator -(__vtype__ v)
        => new(/*# fields.ForEach(f => { */-v.__f__/*# }, comma); */);
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get { return new(/*# fields.ForEach(f => { */1 / __f__/*# }, comma); */); }
    }
    ...
    public static __vtype__ __opaction__(__vtype__ a, __vtype__ b)
        => new(/*# fields.ForEach(f => { */a.__f____op__b.__f__/*# }, comma); */);
    ...
    public static __vtype__ __opaction__(__vtype__ v, __ftype__ s)
        => new(/*# fields.ForEach(f => { */v.__f____op__s/*#  }, comma); */);
    ...
    public static __vtype__ __opaction__(__ftype__ s, __vtype__ v)
        => new(/*# fields.ForEach(f => { */s__op__v.__f__/*# }, comma); */);
    ...
    public static __vtype__ operator __op__(__vtype__ a, __vtype__ b)
        => new(/*# fields.ForEach(f => { */a.__f__ __op__ b.__f__/*# }, comma); */);
    ...
    public static __vtype__ operator __op__(__vtype__ v, __ftype__ s)
        => new(/*# fields.ForEach(f => { */v.__f__ __op__ s/*#  }, comma); */);
    ...
    public static __vtype__ operator __op__(__ftype__ s, __vtype__ v)
        => new(/*# fields.ForEach(f => { */s __op__ v.__f__/*# }, comma); */);
    ...
    public static __vtype__ operator <<(__vtype__ v, int s)
        => new(/*# fields.ForEach(f => { */v.__f__ << s/*#  }, comma); */);
    ...
    public static bool operator ==(__vtype__ a, __vtype__ b)
        => /*# fields.ForEach(f => { */a.__f__ == b.__f__/*# }, andand); */;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(__vtype__ v, __ftype__ s)
        => /*# fields.ForEach(f => { */v.__f__ == s/*# }, andand); */;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(__ftype__ s, __vtype__ v)
        => /*# fields.ForEach(f => { */s == v.__f__/*# }, andand); */;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(__vtype__ a, __vtype__ b)
        => /*# fields.ForEach(f => { */a.__f__ != b.__f__/*# }, oror); */;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(__vtype__ v, __ftype__ s)
        => /*# fields.ForEach(f => { */v.__f__ != s/*# }, oror); */;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(__ftype__ s, __vtype__ v)
        => /*# fields.ForEach(f => { */s != v.__f__/*# }, oror); */;
    ...
    public readonly bool Equals(__vtype__ other)
        => /*# fields.ForEach(f => { */__f__.Equals(other.__f__)/*# }, andand); */;
    ...
    public override readonly int GetHashCode()
        => HashCode.GetCombined(/*# fields.ForEach(f => { */__f__/*# }, comma); */);

    public override readonly bool Equals(object other)
        => (other is __vtype__ o) && Equals(o);
    ...
    public static __vtype__ Parse(string s)
    {
        ...
        return new(/*# d.ForEach(p => { */
            __ftype__.Parse(x[__p__], CultureInfo.InvariantCulture)/*# }, comma); */
        );
    }

    public static __vtype__ Parse(Text t)
        => t.NestedBracketSplit(1, Text<__ftype__>.Parse, __vtype__.Setter);

    public static __vtype__ Parse(Text t, int bracketLevel)
        => t.NestedBracketSplit(bracketLevel, Text<__ftype__>.Parse, __vtype__.Setter);
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public static __v2type__ __name__ => new(__x__, __y__);
    //#             }
    //#         }
    //#         else {
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public readonly __v2type__ __name__ => new(__x__, __y__);
    //#             } else {
    [XmlIgnore]
    [EditorBrowsable(EditorBrowsableState.Never)]
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public static __v3type__ __name__ => new(__x__, __y__, __z__);
    //#                 }
    //#             }
    //#             else {
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public readonly __v3type__ __name__ => new(__x__, __y__, __z__);
    //#                 } else {
    [XmlIgnore]
    [EditorBrowsable(EditorBrowsableState.Never)]
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    {
        readonly get => new(__x__, __y__, __z__);
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public static __v4type__ __name__ => new(__x__, __y__, __z__, __w__);
    //#                         }
    //#                     }
    //#                     else {
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    public readonly __v4type__ __name__ => new(__x__, __y__, __z__, __w__);
    //#                         } else {
    [XmlIgnore]
    [EditorBrowsable(EditorBrowsableState.Never)]
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    {
        readonly get => new(__x__, __y__, __z__, __w__);
    ...
    public readonly __vtype__ Size__d____fchar__ => this;

    #endregion

    #region IVector

    public readonly long Dim => __d__;

    public readonly object GetValue(long index) => (object)this[(int)index];
...
{
    public static __vtype__EqualityComparer Default => new();

    #region IEqualityComparer<__vtype__> Members

    public bool Equals(__vtype__ v0, __vtype__ v1) => v0 == v1;

    public int GetHashCode(__vtype__ v) => v.GetHashCode();
...
public static partial class Fun
{
    ...
    {
        return new(/*# fields.ForEach(f => {*/__fun.Name__(/*# fun.Parameters.ForEach((p, i) => {
        var vec = !p.IsScalar();
        var varg = fun.HasVarArgs && (i == fun.Parameters.Length - 1);
    ...
    public static bool ApproximateEquals(this __vtype__ a, __vtype__ b, __ftype__ tolerance)
        => /*# fields.ForEach(f => { */ApproximateEquals(a.__f__, b.__f__, tolerance)/*# }, andand); */;
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsTiny(this __vtype__ v, __ftype__ epsilon) => Vec.AllTiny(v, epsilon);
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsTiny(__vtype__ v) => v.IsTiny;
...
public static partial class Vec
{
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __ftype__ LengthSquared(__vtype__ v) => v.LengthSquared;

    /// <summary>
    /// Returns the length of the vector.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __ctype__ Length(__vtype__ v) => v.Length;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vctype__ Normalized(__vtype__ v) => v.Normalized;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __ftype__ Norm1(__vtype__ v) => v.Norm1;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __ctype__ Norm2(__vtype__ v) => v.Norm2;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __ftype__ NormMax(__vtype__ v) => v.NormMax;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __ftype__ NormMin(__vtype__ v) => v.NormMin;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Orthogonal(__vtype__ v) => v.Orthogonal;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __vtype__ Reciprocal(__vtype__ v) => v.Reciprocal;
    ...
    public static __mtype__ Outer(this __vtype__ a, __vtype__ b)
        => new(/*# d.ForEach(i => { var fi = fields[i]; */
    ...
    public static __ftype__ Dot(this __vtype__ a, __vtype__ b)
        => /*# fields.ForEach(f => { */a.__f__ * b.__f__/*# }, add); */;
    ...
    public static bool All__opName__(this __vtype__ a, __vtype__ b)
        => (/*# fields.ForEach(f => { */a.__f____bop__b.__f__/*# }, andand); */);
    ...
    public static bool All__opName__(this __vtype__ v, __ftype__ s)
        => (/*# fields.ForEach(f => { */v.__f____bop__s/*# }, andand); */);
    ...
    public static bool All__opName__(__ftype__ s, __vtype__ v)
        => (/*# fields.ForEach(f => { */s__bop__v.__f__/*# }, andand); */);
    ...
    public static bool Any__opName__(this __vtype__ a, __vtype__ b)
        => (/*# fields.ForEach(f => { */a.__f____bop__b.__f__/*# }, oror); */);
    ...
    public static bool Any__opName__(this __vtype__ v, __ftype__ s)
        => (/*# fields.ForEach(f => { */v.__f____bop__s/*# }, oror); */);
    ...
    public static bool Any__opName__(__ftype__ s, __vtype__ v)
        => (/*# fields.ForEach(f => { */s__bop__v.__f__/*# }, oror); */);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __ftype__ MinElement(__vtype__ v) => v.MinElement;

    /// <summary>
    /// Returns the maximum element of the given <see cref="__vtype__"/> vector.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __ftype__ MaxElement(__vtype__ v) => v.MaxElement;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static __ctype__ AngleBetweenFast(this __vtype__ x, __vtype__ y) => Fun.AcosClamped(x.Dot(y));
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool __qant____cond__(__vtype__ v) => v.__qant____cond__;
    ...
    public static __vtype__ LinCom(/*# tpc.ForEach(i => { */__vtype__ p__i__/*# }, comma); */, ref Tup__tpc__<__ftype__> w)
        => /*# tpc.ForEach(i => { */p__i__ * w.E__i__/*# }, add); */;
...
public static class IRandomUniform__vtype__Extensions
{
    ...
    public static __vtype__ Uniform__vtype____v__(this IRandomUniform rnd)
        => new(/*# fields.ForEach(f => { */rnd.Uniform__fcaps____v__()/*#  }, comma); */);
    ...
    public static __vtype__ Uniform__vtype____v__(this IRandomUniform rnd, Box__d____fchar__ box)
        => new(/*# fields.ForEach(f => { */box.Min.__f__ + rnd.Uniform__fcaps____v__() * (box.Max.__f__ - box.Min.__f__)/*#  }, comma); */);
    ...
    public static __vtype__ Uniform__vtype____v__Direction(this IRandomUniform rnd)
    {
        ...
        return new(Fun.Cos(phi), Fun.Sin(phi));
    }
    ...
    public static __vtype__ Uniform__vtype____v__Direction(this IRandomUniform rnd)
    {
        ...
        return new(Fun.Cos(phi) * s, Fun.Sin(phi) * s, z);
    }
    ...
    public static __vtype__ Uniform__vtype__(this IRandomUniform rnd, __ftype__ size)
        => new(/*# fields.ForEach(f => { */rnd.Uniform__fcaps__(size)/*#  }, comma); */);
    ...
    public static __vtype__ Uniform__vtype__(this IRandomUniform rnd, __vtype__ size)
        => new(/*# fields.ForEach(f => { */rnd.Uniform__fcaps__(size.__f__)/*#  }, comma); */);
