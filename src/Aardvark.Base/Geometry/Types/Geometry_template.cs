...
public partial struct __type__ : IEquatable<__type__>, IValidity, IPolygon<__tvec__>, IBounding__tbox__
{
    ...
    public static readonly __type__ Invalid = new(null, 0);
...
public readonly partial struct __indextype__ : IValidity, IPolygon<__tvec__>
{
    ...
    public static readonly __indextype__ Invalid = new(null, 0, 0, null);
...
public partial struct __type__ : IEquatable<__type__>, IValidity, IPolygon<__tvec__>, IBounding__tbox__
{
    ...
    public readonly __tline__ GetEdgeLine(int index) => index switch
    {
        //# pc.ForEach(i => { var j = (i + 1) % pc;
        __i__ => new __tline__(P__i__, P__j__),
        //# });
        _ => throw new InvalidOperationException()
    };

    public readonly __tvec__ GetEdge(int index) => index switch
    {
        //# pc.ForEach(i => { var j = (i + 1) % pc;
        __i__ => P__j__ - P__i__,
        //# });
