...
public readonly struct ObliqueCone3f : IEquatable<ObliqueCone3f>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator ObliqueCone3f(ObliqueCone3d c) => new(c);
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(V3f.NaN, Circle3f.Invalid);
    }
    ...
    public override bool Equals(object other)
        => (other is ObliqueCone3f o) && Equals(o);
...
public readonly struct ObliqueCone3d : IEquatable<ObliqueCone3d>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator ObliqueCone3d(ObliqueCone3f c) => new(c);
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(V3d.NaN, Circle3d.Invalid);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override bool Equals(object other)
        => (other is ObliqueCone3d o) && Equals(o);
