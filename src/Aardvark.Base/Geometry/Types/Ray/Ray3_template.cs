...
namespace Aardvark.Base
{
    ...
    public partial struct __ray3t__ : IEquatable<__ray3t__>, IValidity, __iboundingbox__
    {
        ...
        /// <summary>
        /// Returns true if the ray intersects with the circle. A hit with this
        /// overload is considered for t in [0, __ftype__.MaxValue). On failure,
        ...
        private readonly bool TryGetCircleHit(
            __v3t__ center, __v3t__ normal, __ftype__ radius,
        ...
        private static bool IsInsideScaledDisk(
            __ftype__ x, __ftype__ y, __ftype__ z, __ftype__ radius)
        {
            var scale = Fun.Max(
            ...
            __ftype__ x, __ftype__ y, __ftype__ z, __ftype__ radius)
        {
            ...
            if (radiusSquared >= __minNormal__ && radiusSquared <= __ftype__.MaxValue)
