...
public partial struct Hull3f : IEquatable<Hull3f>, IValidity
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator Hull3f(Hull3d h) => new(h);
    ...
    public readonly Hull3f Reversed()
        => new(PlaneArray.Map(p => p.Reversed));
...
public struct FastHull3f
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator FastHull3f(FastHull3d h) => new(h);
...
public partial struct Hull3d : IEquatable<Hull3d>, IValidity
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator Hull3d(Hull3f h) => new(h);
...
public struct FastHull3d
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator FastHull3d(FastHull3f h) => new(h);
