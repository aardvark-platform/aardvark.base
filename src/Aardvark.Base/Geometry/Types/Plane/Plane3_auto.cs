...
public partial struct Plane3f : IEquatable<Plane3f>, IValidity, IBoundingBox3f
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator Plane3f(Plane3d o) => new(o);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator Plane3f(PlaneWithPoint3f o) => new(o.Normal, o.Point);
...
public struct PlaneWithPoint3f : IBoundingBox3f
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator PlaneWithPoint3f(PlaneWithPoint3d o) => new(o);
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(Normal.Normalized, Point);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override readonly bool Equals(object other)
        => (other is PlaneWithPoint3f o) && Equals(o);
...
public struct PlanePair3f
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator PlanePair3f(PlanePair3d o) => new(o);
...
public struct PlaneTriple3f
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator PlaneTriple3f(PlaneTriple3d o) => new(o);
...
public static class Plane3fExtensions
{
    ...
    {
        if (pointArray == null) throw new ArgumentNullException(nameof(pointArray));
        if (startIndex < 0 || startIndex >= pointArray.Length) throw new ArgumentOutOfRangeException(nameof(startIndex));
...
public partial struct Plane3d : IEquatable<Plane3d>, IValidity, IBoundingBox3d
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator Plane3d(Plane3f o) => new(o);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator Plane3d(PlaneWithPoint3d o) => new(o.Normal, o.Point);
...
public struct PlaneWithPoint3d : IBoundingBox3d
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator PlaneWithPoint3d(PlaneWithPoint3f o) => new(o);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override readonly bool Equals(object other)
        => (other is PlaneWithPoint3d o) && Equals(o);
...
public struct PlanePair3d
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator PlanePair3d(PlanePair3f o) => new(o);
...
public struct PlaneTriple3d
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator PlaneTriple3d(PlaneTriple3f o) => new(o);
