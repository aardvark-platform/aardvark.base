...
public partial struct __plane3t__ : IEquatable<__plane3t__>, IValidity, __iboundingbox3t__
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator __plane3t__(__plane3t2__ o) => new(o);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator __plane3t__(__planewithpoint3t__ o) => new(o.Normal, o.Point);
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(__v3t__.XAxis, __v3t__.Zero);
    }
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(__v3t__.YAxis, __v3t__.Zero);
    }
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(__v3t__.ZAxis, __v3t__.Zero);
    }
    ...
    public override readonly bool Equals(object other)
        => (other is __plane3t__ o) && Equals(o);
...
public struct __planewithpoint3t__ : __iboundingbox3t__
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator __planewithpoint3t__(__planewithpoint3t2__ o) => new(o);
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(__v3t__.Zero, __v3t__.Zero);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override readonly bool Equals(object other)
        => (other is __planewithpoint3t__ o) && Equals(o);
...
public struct __planepair3t__
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator __planepair3t__(__planepair3t2__ o) => new(o);
...
public struct __planetriple3t__
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator __planetriple3t__(__planetriple3t2__ o) => new(o);
