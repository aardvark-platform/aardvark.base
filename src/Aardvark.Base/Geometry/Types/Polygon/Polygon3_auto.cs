...
public static partial class Polygon3fExtensions
{
    ...
    public static Plane3f ComputePlane3f(this Polygon3f polygon)
        => new(polygon.ComputeNormal(), polygon.ComputeVertexCentroid());
    ...
    public static Plane3f GetPlane3f(this Polygon3f polygon)
        => new(polygon[0], polygon[1], polygon[2]);
    ...
    {
        if (toleranceAbsolute < 0) throw new ArgumentOutOfRangeException(nameof(toleranceAbsolute));
        var pc = polygon.PointCount;
    ...
    {
        if (toleranceInDegrees < 0) throw new ArgumentOutOfRangeException(nameof(toleranceInDegrees));
