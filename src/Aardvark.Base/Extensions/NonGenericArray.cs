...
namespace Aardvark.Base;
	...
	[Obsolete]
	private static readonly Dictionary<Type, Func<Array, Array>> CopyFunMap = new()
        {
        ...
        [Obsolete]
        private static readonly Dictionary<Type, Func<Array, object, Array>> CopyFunFunMap = new()
        {
	...
	private static readonly Dictionary<Type, Func<Array, int, Array>> ResizedFunMap = new()
    {
	...
	private static readonly Dictionary<Type, Func<Array, int[], int[], int, Array>>
		BackMappedIndexedCopyFunMap = new()
        {
	...
	private static readonly Dictionary<Type, Action<Array, Array, int, int[], int[], int>>
		BackMappedGroupCopyToFunMap = new()
        {
