...
public static class HighFun
{
    ...
    {
        Func<T0, TR> rec(Recursive<T0, TR> r) => a0 => f(r(r))(a0);
        return rec(rec);
    }
    ...
    {
        Func<T0, T1, TR> rec(Recursive<T0, T1, TR> r) => (a0, a1) => f(r(r))(a0, a1);
        return rec(rec);
    }
    ...
    {
        Func<T0, T1, T2, TR> rec(Recursive<T0, T1, T2, TR> r) => (a0, a1, a2) => f(r(r))(a0, a1, a2);
        return rec(rec);
    }
    ...
    {
        Func<T0, T1, T2, T3, TR> rec(Recursive<T0, T1, T2, T3, TR> r) => (a0, a1, a2, a3) => f(r(r))(a0, a1, a2, a3);
        return rec(rec);
    }
