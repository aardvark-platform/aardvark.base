...
public static class Report
{
    ...
    public static Telemetry.Counter CountCallsToBeginTimed = new();
    public static Telemetry.Counter CountCallsToBegin = new();
    public static Telemetry.Counter CountCallsToEnd = new();
    public static Telemetry.Counter CountCallsToLine = new();
    public static Telemetry.Counter CountCallsToText = new();
    public static Telemetry.Counter CountCallsToWarn = new();
    public static Telemetry.Counter CountCallsToDebug = new();
    public static Telemetry.Counter CountCallsToTrace = new();
    public static Telemetry.Counter CountCallsToError = new();
    public static Telemetry.Counter CountCallsToFatal = new();
    public static Telemetry.Counter CountCallsToValues = new();
    public static Telemetry.Counter CountCallsToProgress = new();
    ...
    public static readonly PerThreadJobReporter ThreadedJobReporter = new() { Indent = 2 };
    public static readonly JobReporter JobReporter = new() { Indent = 2 };
...
#pragma warning restore IDE0060 // Remove unused parameter
    ...
    public static void ConsoleColoredWriteAct(int threadIndex, LogType type, int level, string message)
    {
        ...
        switch (type)
        {
            ...
            case LogType.Info: Console.ForegroundColor = level switch
                {
                    0 => s_defaultForeground,
                    1 => ConsoleColor.Gray,
    ...
    public readonly static TextLogTarget LogTarget
             = new((firstThreadIndex, firstType, firstLevel, firstMessage) =>
             {
    ...
    public readonly static PerThreadLogTarget PerThreadLogTarget = new(CreatePerThreadLogTarget);

    private static TextLogTarget CreatePerThreadLogTarget(int index)
    {
        TextLogTarget logTarget = new(null, index) { Width = 100, Verbosity = 9, Synchronized = false };
        logTarget.WriteAct = (firstThreadIndex, firstType, firstLevel, firstMessage) =>
        {
    ...
    /// </summary>
    public readonly static MultiLogTarget Targets = new(ConsoleTarget, LogTarget);
    ...
    public static void Fatal([Localizable(true)] string line, params object[] args)
    {
        ...
        _ = new System.Diagnostics.StackTrace(1);
