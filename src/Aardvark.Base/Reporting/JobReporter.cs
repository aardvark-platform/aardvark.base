...
{
    public class JobReporter(int threadIndex = 0) : IJobReporter
    {
        private readonly int m_ti = threadIndex;
        public int m_indent = 2;
        private ReportJob m_job = new("THREAD", 0, true);
        private readonly Stack<ReportJob> m_jobStack = new();
        private volatile IReporter[] m_reporterArray = null;
        private readonly object m_reporterArrayLock = new();
