...
public class Awaitable : IAwaitable, IEventEmitter<Unit>
{
    ...
    public void Emit()
    {
        ...
        if (old == 0)
        {
            ...
            if (actions != null)
            {
                var acts = Interlocked.Exchange(ref actions, []);
    ...
    private readonly struct Awaiter(Awaitable source) : IAwaiter
    {
        private readonly Awaitable m_source = source;
...
public class Awaitable<T> : IAwaitable<T>, IEventEmitter<T>
{
    ...
    public Awaitable(CancellationToken? ct = null)
    {
        ...
        if (m_ct.HasValue)
        {
            if (m_ct.Value.CanBeCanceled)
            {
                m_ctRegistration = m_ct.Value.Register(() => Emit(default));
            }
        }
    ...
    private readonly struct Awaiter(Awaitable<T> source) : IAwaiter<T>
    {
        private readonly Awaitable<T> m_source = source;
...
public static class Await
{
    /// <summary>
    /// </summary>
    public static readonly Clock GlobalClock = new(120);
...
/// <summary>
/// </summary>
public class TaskAwaiter<T>(System.Runtime.CompilerServices.TaskAwaiter<T> awaiter) : IAwaiter<T>
{
    private System.Runtime.CompilerServices.TaskAwaiter<T> m_awaiter = awaiter;
...
/// <summary>
/// </summary>
public class TaskAwaiter(System.Runtime.CompilerServices.TaskAwaiter awaiter) : IAwaiter
{
    private System.Runtime.CompilerServices.TaskAwaiter m_awaiter = awaiter;
...
/// <summary>
/// </summary>
public class TaskAwaitable<T>(Task<T> task) : IAwaitable<T>
{
    private readonly Task<T> m_task = task;
...
/// <summary>
/// </summary>
public class TaskAwaitable(Task task) : IAwaitable
{
